...
```
At this point you should use explore the contents of the tutorial folder.  There are several .R files that you will run to prepare the data.  Before you run them, use cat <filename> or nano <filename> to look at the content of the various .R files to see what each is doing.
...
There are several files that the above code puts out in the 
